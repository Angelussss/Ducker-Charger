...
/** two presses inside this window = jump straight to SETTINGS */
#define UI_DOUBLE_CLICK_MS      400
...
typedef enum {
    ...
    UI_SCREEN_PORTS,      /**< one graph, five port traces + legend */
    UI_SCREEN_STATS,      /**< lifetime + session numbers */
...
/** close SETTINGS overlay, go back where it was opened from */
