...
#define COLOR_ACCENT  0xFC60  /**< Vivid orange for active elements */
#define COLOR_HEADER  0x0988  /**< Dark blue-teal header/footer band */
#define COLOR_LIME    0x87E0  /**< Bright green */
#define COLOR_PORT_A1 COLOR_CYAN
#define COLOR_PORT_A2 COLOR_LIME
#define COLOR_MAGENTA 0xF81F
#define COLOR_PORT_C2 COLOR_MAGENTA
#define COLOR_PORT_LAB COLOR_YELLOW
